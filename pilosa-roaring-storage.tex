...
\begin{tikzpicture}
  ...
  \block[] {
    ...
    \block[minimum width=16em]{
      ...
      2 \block[minimum width=14em,text=darkgreen]{Storage version}\\
      % "\," is a space
      4 \block[minimum width=14em]{$\textcolor{red}{N_c}$\textcolor{darkblue}{\, = Container count}}
    ...
    \block[minimum width=16em]{
      ...
      \block[minimum width=15em]{
        ...
        2 \block[minimum width=13em,text=darkgreen]{{Container type 0}}\\
        2 \block[minimum width=13em]{\textcolor{red}{Cardinality 0}}
      }\\
      \vdots \\
