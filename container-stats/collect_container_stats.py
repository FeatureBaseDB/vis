...
<index>-<frame>/standard-<fragmentID>.txt

/<index>/views/field_<field>/fragments/<fragmentID>
/<index>/views/field_<field>/fragments/<fragmentID>.cache
<index>-<frame>/field_<field>-<fragmentID>.txt

cd ~ && tar czf ssb-container-stats.tar.gz */*
scp ubuntu@node0.ssb.sandbox.pilosa.com:/home/ubuntu/container-stats/ssb-container-stats.tar.gz .
